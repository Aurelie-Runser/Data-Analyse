...
const selection = async (reg) =>{
    ...
    .then(response =>{
        ...
        listeHydrau.value = response.records;
        ...
        // Parcours des gares
        listeHydrau.value.forEach( (gare) =>{
        ...
        /*
        Positionnement sur lensemble des markers
        la fonction fitBounds permet de repositionner la carte
        sur le centre d'un ensemble de latitude/longitude
        la fonction getBounds permet de donner les deux points ectreme
...
<template>
    <div>
        <div>
            <h2>Installations de production Hydraulique en France métropolitaine en 2020</h2>
