<script setup>
    ...
    import {getProdHydrau} from "@/composables/serviceAjax.js"
...
<template>
    <div>
        <h2>Graphique du nombre d'installations de production Hydraulique par régions en France métropolitaine en 2020</h2>
        <Doughnut
